...
update_mysql_setting mysql_innodb_io_capacity ${MYSQL_INNODB_IO_CAPACITY}
update_mysql_setting mysql_innodb_log_file_size ${MYSQL_INNODB_LOG_FILE_SIZE}
update_mysql_setting mysql_query_cache_size ${MYSQL_QUERY_CACHE_SIZE}
update_mysql_setting mysql_tmp_table_size ${MYSQL_TMP_TABLE_SIZE}
update_mysql_setting mysql_table_open_cache ${MYSQL_TABLE_OPEN_CACHE}
